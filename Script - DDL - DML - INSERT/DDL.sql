...
CREATE TABLE ASISTENCIA 
    (
	 ...
	 fecha_registro_asiste DATE NOT NULL,
...
CREATE TABLE CERTIFICACION 
    (
     ...
     tiene_certificacion BIT NOT NULL DEFAULT 1, -- Por defecto TRUE (Tiene Certificación) 
...
CREATE TABLE EVENTO 
    (
     ...
     INSIGNIA_insignia_id INTEGER NULL
    )
GO 
...
ALTER TABLE EVENTO 
    ADD CONSTRAINT EVENTO_INSIGNIA_FK FOREIGN KEY 
    ( 
     INSIGNIA_insignia_id
    ) 
    REFERENCES INSIGNIA 
