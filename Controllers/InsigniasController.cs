...
namespace EmPoderTIC.Controllers
{
    public class InsigniasController : Controller
    {
        ...
        {
            var iNSIGNIA = db.INSIGNIA.Include(i => i.AREA).Include(i => i.CERTIFICACION).Include(i => i.COMPETENCIA).Include(i => i.EVENTO1).Include(i => i.NIVEL);
        ...
        public async Task<ActionResult> Create([Bind(Include = "insignia_id,nombre,descripción,objetivo,imagen_url,fecha_otorgamiento,insignia_bloqueada,NIVEL_nivel_id,AREA_area_id,COMPETENCIA_competencia_id,CERTIFICACION_certificacion_id,EVENTO_evento_id")] INSIGNIA iNSIGNIA)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "insignia_id,nombre,descripción,objetivo,imagen_url,fecha_otorgamiento,insignia_bloqueada,NIVEL_nivel_id,AREA_area_id,COMPETENCIA_competencia_id,CERTIFICACION_certificacion_id,EVENTO_evento_id")] INSIGNIA iNSIGNIA)
        {
            if (ModelState.IsValid)
            {
