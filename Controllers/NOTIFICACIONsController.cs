...
namespace EmPoderTIC.Controllers
{
    public class NOTIFICACIONsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "notificacion_id,mensaje,fecha,solicitud_aprobada,USUARIO_rut,INSIGNIA_insignia_id")] NOTIFICACION nOTIFICACION)
        {
